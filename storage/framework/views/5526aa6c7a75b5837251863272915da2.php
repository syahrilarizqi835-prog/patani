    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #patani-loader {
            ...
            z-index: 99999;
            overflow: hidden;
            background: #030e05 url("<?php echo e(asset('images/agri-land-wallpapers.jpg')); ?>") center center / cover no-repeat;
...
<div class="sawah-full-bg">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-white hover:text-green-400 transition">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-500 shadow-md transition">Daftar</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section class="py-6 px-6">
        <div class="rounded-2xl py-16 px-8 text-center" style="background:rgba(10,30,12,0.45);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(80,200,100,0.18);box-shadow:0 8px 32px rgba(0,0,0,0.40),inset 0 1px 0 rgba(255,255,255,0.06);">
            ...
            <a href="<?php echo e(route('register')); ?>" class="inline-block px-10 py-4 bg-green-600 text-white rounded-xl text-lg font-semibold hover:bg-green-500 hover:scale-105 transition" style="box-shadow:0 0 24px rgba(34,197,94,0.35);">Daftar Gratis Sekarang</a>
        </div>
    </section>
...
</html><?php /**PATH C:\xampp\htdocs\patani\laravel-patani\resources\views/landing/index.blade.php ENDPATH**/ ?>