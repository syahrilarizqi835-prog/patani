<?php $__env->startSection('page-title', 'Data Sawah'); ?>
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-white rounded-xl shadow border border-gray-200 overflow-hidden hover:shadow-md transition">
            ...
            <div class="relative h-48 bg-gray-100">
                <?php if($sawah->foto_lahan): ?>
                    <img src="<?php echo e(asset('storage/' . $sawah->foto_lahan)); ?>"
                        alt="Foto <?php echo e($sawah->nama_sawah); ?>"
                ...
                <div class="absolute top-3 right-3">
                    <span class="px-2 py-1 text-xs font-bold rounded-full
                        <?php echo e($sawah->status === 'aktif' ? 'bg-green-500 text-white' :
                           ($sawah->status === 'panen' ? 'bg-yellow-500 text-white' : 'bg-gray-500 text-white')); ?>">
                        <?php echo e(ucfirst($sawah->status)); ?>
            ...
            <div class="p-4">
                <h3 class="font-bold text-gray-800 text-lg mb-1"><?php echo e($sawah->nama_sawah); ?></h3>
                <p class="text-sm text-gray-500 mb-3">
                    <i class="fas fa-map-marker-alt text-red-400 mr-1"></i>
                    <?php echo e($sawah->desa); ?>, <?php echo e($sawah->kecamatan); ?>
                ...
                <div class="grid grid-cols-2 gap-2 mb-3">
                    <div class="bg-gray-50 rounded-lg p-2 text-center">
                        ...
                        <p class="font-bold text-gray-800"><?php echo e($sawah->luas); ?> Ha</p>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-2 text-center">
                        <p class="text-xs text-gray-500">Jenis Padi</p>
                        <p class="font-bold text-gray-800 text-sm"><?php echo e($sawah->jenis_padi); ?></p>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-2 text-center">
                        <p class="text-xs text-gray-500">Tanah</p>
                        <p class="font-semibold text-sm capitalize
                            <?php echo e($sawah->kondisi_tanah === 'subur' ? 'text-green-700' :
                               ($sawah->kondisi_tanah === 'sedang' ? 'text-yellow-700' : 'text-red-700')); ?>">
                            <?php echo e(ucfirst($sawah->kondisi_tanah)); ?>
                    ...
                    <div class="bg-gray-50 rounded-lg p-2 text-center">
                        ...
                        <p class="font-semibold text-sm capitalize
                            <?php echo e($sawah->kondisi_air === 'baik' ? 'text-blue-700' :
                               ($sawah->kondisi_air === 'cukup' ? 'text-yellow-700' : 'text-red-700')); ?>">
                            <?php echo e(ucfirst($sawah->kondisi_air)); ?>

                        </p>
                    </div>
                </div>

                <?php if($sawah->estimasi_panen): ?>
                <p class="text-xs text-gray-500 mb-3">
                    <i class="fas fa-calendar text-green-500 mr-1"></i>
                    Estimasi panen: <?php echo e(\Carbon\Carbon::parse($sawah->estimasi_panen)->format('d M Y')); ?>
                ...
                <div class="flex gap-2 pt-2 border-t">
                    <button
                        @click="openEdit(<?php echo e($sawah->toJson()); ?>)"
                    ...
                    <form action="<?php echo e(route('dashboard.sawah.destroy', $sawah->id)); ?>" method="POST"
                        onsubmit="return confirm('Yakin hapus sawah <?php echo e($sawah->nama_sawah); ?>?')">
                        <?php echo csrf_field(); ?>
...
<div x-show="!editMode">
    <form action="<?php echo e(route('dashboard.sawah.store')); ?>" method="POST"
        ...
        <div class="flex gap-3 pt-2 sticky bottom-0 bg-white pb-2">
            ...
            <button type="submit"
                ...
                <div x-show="editMode">
                    <?php $__currentLoopData = $sawahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sawah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form
                        x-show="editId === <?php echo e($sawah->id); ?>"
                        action="<?php echo e(route('dashboard.sawah.update', $sawah->id)); ?>"
                        method="POST"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Sawah *</label>
                                <input type="text" name="nama_sawah" value="<?php echo e($sawah->nama_sawah); ?>" required
                                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Luas (Ha) *</label>
                                <input type="number" name="luas" step="0.01" value="<?php echo e($sawah->luas); ?>" required
                                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Lokasi *</label>
                            <input type="text" name="lokasi" value="<?php echo e($sawah->lokasi); ?>" required
                                class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Desa *</label>
                                <input type="text" name="desa" value="<?php echo e($sawah->desa); ?>" required
                                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Kecamatan *</label>
                                <input type="text" name="kecamatan" value="<?php echo e($sawah->kecamatan); ?>" required
                                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Jenis Padi *</label>
                                <input type="text" name="jenis_padi" value="<?php echo e($sawah->jenis_padi); ?>" required
                                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Tanam</label>
                                <input type="date" name="tanggal_tanam"
                                    value="<?php echo e($sawah->tanggal_tanam ? $sawah->tanggal_tanam->format('Y-m-d') : ''); ?>"
                                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="kondisi_tanah" required class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                                    <option value="subur" <?php echo e($sawah->kondisi_tanah === 'subur' ? 'selected' : ''); ?>>Subur</option>
                                    <option value="sedang" <?php echo e($sawah->kondisi_tanah === 'sedang' ? 'selected' : ''); ?>>Sedang</option>
                                    <option value="kurang" <?php echo e($sawah->kondisi_tanah === 'kurang' ? 'selected' : ''); ?>>Kurang</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Kondisi Air *</label>
                                <select name="kondisi_air" required class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                                    <option value="baik" <?php echo e($sawah->kondisi_air === 'baik' ? 'selected' : ''); ?>>Baik</option>
                                    <option value="cukup" <?php echo e($sawah->kondisi_air === 'cukup' ? 'selected' : ''); ?>>Cukup</option>
                                    <option value="kurang" <?php echo e($sawah->kondisi_air === 'kurang' ? 'selected' : ''); ?>>Kurang</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="fase_tanam" required class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                                    <?php $__currentLoopData = ['persiapan','vegetatif','generatif','pematangan','panen']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($fase); ?>" <?php echo e($sawah->fase_tanam === $fase ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="status" required class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                                    <option value="aktif" <?php echo e($sawah->status === 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                                    <option value="panen" <?php echo e($sawah->status === 'panen' ? 'selected' : ''); ?>>Panen</option>
                                    <option value="istirahat" <?php echo e($sawah->status === 'istirahat' ? 'selected' : ''); ?>>Istirahat</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Catatan</label>
                            <textarea name="catatan" rows="2"
                                class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"><?php echo e($sawah->catatan); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\patani\laravel-patani\resources\views/dashboard/sawah.blade.php ENDPATH**/ ?>