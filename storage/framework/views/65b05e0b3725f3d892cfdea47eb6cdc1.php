<?php $__env->startSection('page-title', 'Informasi Cuaca'); ?>
...
<div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div>
                ...
                <h2 class="text-3xl md:text-4xl font-bold mt-2">
                    <?php echo e(auth()->user()->desa ?? 'Indramayu'); ?>, Jawa Barat
                </h2>
                ...
                <div class="flex items-center gap-4 mt-6">
                    ...
                    <div>
                        <div class="text-5xl md:text-6xl font-bold">
                            <?php echo e(round($current['main']['temp'] ?? 0)); ?>°C
                        </div>
                        <p class="text-xl opacity-90 capitalize">
                            <?php echo e($current['weather'][0]['description'] ?? '-'); ?>
            ...
            <div class="text-right space-y-3">
                <div class="flex items-center gap-3 justify-end">
                    ...
                    <span class="font-bold text-xl">
                        <?php echo e($current['main']['humidity'] ?? '-'); ?>%
                    </span>
                </div>
                ...
                <div class="flex items-center gap-3 justify-end">
                    ...
                    <span class="font-bold text-xl">
                        <?php echo e($current['rain']['1h'] ?? 0); ?> mm
                    </span>
                </div>
                ...
                <div class="flex items-center gap-3 justify-end">
                    <span>Kec. Angin</span>
                    <span class="font-bold text-xl">
                        <?php echo e($current['wind']['speed'] ?? 0); ?> km/h
                    </span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <?php $__currentLoopData = $daily; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="bg-gray-50 rounded-lg p-4 text-center hover:bg-blue-50 transition">
                    <p class="font-semibold text-gray-700 mb-2"><?php echo e($day); ?></p>
                    <p class="text-sm text-gray-600 capitalize mb-2"><?php echo e($condition); ?></p>
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($temp); ?>°C</p>
                    <p class="text-sm text-gray-500 mt-1">💧 <?php echo e($humidity); ?>%</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
            ...
            <?php if(($current['wind']['speed'] ?? 0) < 10): ?>
            ...
            <?php if(($current['main']['humidity'] ?? 0) > 80): ?>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = $rekomList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $colorMap = [
            ...
            ?>
            <div class="flex items-start gap-3 p-4 <?php echo e($c['bg']); ?> border <?php echo e($c['border']); ?> rounded-lg">
                <i class="<?php echo e($r['icon']); ?> <?php echo e($c['icon']); ?> mt-1 text-lg"></i>
                <div>
                    <p class="font-semibold <?php echo e($c['title']); ?>"><?php echo e($r['judul']); ?></p>
                    <p class="text-sm <?php echo e($c['text']); ?> mt-0.5"><?php echo e($r['isi']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\patani\laravel-patani\resources\views/dashboard/cuaca.blade.php ENDPATH**/ ?>